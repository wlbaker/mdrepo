...
public class DisplayKnob extends JComponent {
	...
	public void setValue(float req_val) {

		if (req_val == Float.NaN) {
			this.val = Float.NaN;
			this.ang = Float.NaN;
		} else {
			this.val = req_val / 100;
	...
	private void drawText(Graphics g, int middle, String s) {
		...
		g2.drawString(s, middle - sw / 2, middle + sh / 3);
