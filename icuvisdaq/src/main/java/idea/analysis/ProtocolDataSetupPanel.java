...
public class ProtocolDataSetupPanel extends JPanel implements
	...
	static { 
		...
		analysisInfo.setName("Protocol Data Setup");
		analysisInfo.setAnalysisClass( ProtocolDataSetupPanel.class.getCanonicalName() );
		// analysisInfo.
	}
	private RpAnalysis anal;
	private RpDevice currentDev;

	public ProtocolDataSetupPanel(RpStudy study, RpAnalysis anal) {
		initComponents();
