...
import idea.GuiUtil;
import idea.adapters.gui.CombinedRateVolumeChart;
...
public class Impact731Panel extends JPanel implements StreamConsumer, RefreshablePanel {
	...
	public Impact731Panel(StreamProducer ddriver, RpDevice conf) {
		initComponents();
