...
//import icuInterface.adapters.NIDAQmxBaseDriver;
//import icuInterface.adapters.NIDAQmxDriver;
...
public class WizNationalInstrumentsPanel extends JPanel implements WizardPanelInterface {
	...
	public WizNationalInstrumentsPanel(WizardMasterInterface wizard, RpDevice conf) {
	...
	public void _refreshSignals() throws IOException {
		...
		// FIXME: NIDAQmx drivers are...where?
//		if (useBase) {
//			driver = new NIDAQmxBaseDriver(null);
//		} else {
//			driver = new NIDAQmxDriver(null);
//		}
