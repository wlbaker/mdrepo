...
public class WizRemoteEntryPanel extends JPanel implements WizardPanelInterface {
	...
	private EntryModel entry_model;

	public static final String REMOTEENTRY_LOAD_FILE = "remoteentry_load";
	...
	void refresh(File f) {
		try {
			entry_model = EntryUtil.loadEntrySheets(f);
			refresh(entry_model.getSheets());
	...
	private JTable buildTableFromEntrySheet(EntrySheet sheet) {
		...
		//---- table1 ----
		table.setModel(new DefaultTableModel(new Object[][] { { null, "ART_SYS", "Systolic", "[50,220]" },
				{ null, "ART_DIA", "Diastolic", null }, { null, "ART_MAP", null, null }, }, new String[] { "O", "Key",
				"Prompt", "Validation" }) {
	...
	private void initComponents() {
		...
		setLayout(new FormLayout("default:grow", "default, $lgap, fill:default:grow"));
		...
		//======== tabber ========
		{
			...
			//======== scrollPane2 ========
			{
				...
				scrollPane2.setViewportView(table0);
			}
	...
	protected void panelToModel() {
		...
		// dc.setDeviceClass(IDEAProxyDevice.class.getCanonicalName());
		...
		params.put("excelFile", "--not given--");
