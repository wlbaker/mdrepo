...
public class StudyWizard extends JPanel implements WizardMasterInterface {

	private final static String STUDY_HEADER = "Study Definition";
	...
	DefaultStudyHeaderPanel headerPanel;
	...
	public StudyWizard() {
		...
		safeAdd(headerPanel = new DefaultStudyHeaderPanel( this ), STUDY_HEADER);

		buildWizardNavigationTree();
		tree.setSelectionInterval(0, 0);

		setCurrentPanel( STUDY_HEADER );
	}
	...
	private void buildWizardNavigationTree() {
		...
		root.add(new DefaultMutableTreeNode(STUDY_HEADER));
	...
	private void nextActionPerformed(ActionEvent e) {
		...
		if (curr.equals(STUDY_HEADER)) {
			nextPage = null;  // trigger finish
		}
