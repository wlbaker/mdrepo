...
public class SQLCheckAnnotatedCapabilities {
	...
	public static void main(String[] args) throws IOException {
		...
		// run_driver_comparisons(new EvitaDriver(null), DragerEvita.class );
		System.out.println("you must specify the driver to test...in the code");
		
	}

//	private static void run_driver_comparisons(StreamProducer driver, Class<?> db_class ) {
//			DeviceCapabilities caps = driver.getStaticCapabilities();
//			RpMetric[] dev_metrics = caps.getMetrics();
...
//	}
	...
	private static void add_all_metrics(Map<String, RpMetric> db_map, RpMetric[] db_metrics) {
		for (RpMetric metric : db_metrics) {
			db_map.put(metric.getLocation().toString(), metric);
		}
	...
	private static void log_not_found(String prefix, RpMetric rpMetric) {
		System.out.print(prefix);
		System.out.print(": ");
		System.out.println(rpMetric.toString());
	}
