...
//		long size = H5.H5Tget_size(tid);
		...
		if(	H5.H5Oexists_by_name(file_id, datasetSuffixName, HDF5Constants.H5P_DEFAULT) ) {
			out.println("object (dataset?) exists");
		} else {
			out.println("NO object (dataset?) exists");
		}
...
//		H5.H5Dclose(dataset_id);
	...
	public static void r2(String H5_FILE ) {
		PlatformUtil.init();
