...
AlarmContextTypeBuilder::AlarmContextTypeBuilder() :
...
DicesRcEntityBuilder AlarmContextTypeBuilder::register_type()
{
  if(!get_participant())
  {
...
const std::string AlarmContextTypeBuilder::get_type_name()
{
  return ice::AlarmContextTypeSupport::get_type_name();
}
