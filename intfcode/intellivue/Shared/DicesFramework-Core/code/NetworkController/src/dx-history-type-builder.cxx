...
DxHistoryTypeBuilder::DxHistoryTypeBuilder() :
...
DicesRcEntityBuilder DxHistoryTypeBuilder::register_type()
{
  if(!get_participant())
  {
...
const std::string DxHistoryTypeBuilder::get_type_name()
{
  return expr::DxHistoryTypeSupport::get_type_name();
}
