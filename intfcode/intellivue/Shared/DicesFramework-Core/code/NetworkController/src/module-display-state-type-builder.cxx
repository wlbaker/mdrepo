...
ModuleDisplayStateTypeBuilder::ModuleDisplayStateTypeBuilder() :
...
DicesRcEntityBuilder ModuleDisplayStateTypeBuilder::register_type()
{
  if(!get_participant())
  {
...
const std::string ModuleDisplayStateTypeBuilder::get_type_name()
{
  return docbox::ModuleDisplayStateTypeSupport::get_type_name();
}
