...
ModuleServiceStateTypeBuilder::ModuleServiceStateTypeBuilder() :
...
DicesRcEntityBuilder ModuleServiceStateTypeBuilder::register_type()
{
  if(!get_participant())
  {
...
const std::string ModuleServiceStateTypeBuilder::get_type_name()
{
  return docbox::ModuleServiceStateTypeSupport::get_type_name();
}
