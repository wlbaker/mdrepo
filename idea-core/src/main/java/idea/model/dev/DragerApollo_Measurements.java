...
public class DragerApollo_Measurements extends PersistentItem {

	@Transient
	private static RpMetric[] metrics;

	static {
		metrics = IntfUtil.buildMetrics(DragerApollo_Measurements.class);
	}

	public DragerApollo_Measurements() {
	...
	private int InspTV; //
	@Metric(loc = "0xB4", desc = "Respiratory Rate (Pressure)", unit = "1/min")
	private int RR; //
	@Metric(loc = "0xB9", desc = "Respiratory Minute Volume", unit = "L", precision = 3)
	private int MV; //
	@Metric(loc = "0xBD", desc = "Apnea Duration", unit = "sec")
	private int APNEA; //
	@Metric(loc = "0xD7", desc = "Respiratory Rate", unit = "1/min")
	private int RRd7; //
	@Metric(loc = "0xD9", desc = "Respiratory Rate", unit = "1/min")
	private int RRd9; //
