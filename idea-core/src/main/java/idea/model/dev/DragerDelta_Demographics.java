...
@Entity
@Table(name = "DragerDelta$Demographics")
@Data
public class DragerDelta_Demographics extends PersistentItem {

	@Transient
	private static RpMetric[] metrics;

	static {
		metrics = IntfUtil.getMetrics(DragerDelta_Demographics.class);
	}
	...
	public DragerDelta_Demographics() {
		this(0);
	}

	public DragerDelta_Demographics(long time) {
		super(StreamID.DDDEMOGRAPHICS);
