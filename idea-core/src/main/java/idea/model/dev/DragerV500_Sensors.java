...
@Data
public class DragerV500_Sensors extends PersistentItem {
	...
	static {
		metrics = IntfUtil.getMetrics(DragerV500_Sensors.class);
	}
	...
	@Waveform(loc="0x06",  code="etCO2", desc="Exp CO" + two_subscript, freq=126, spp=WF_PACKET_SIZE, unit="mbar", precision=1) private int [] EtCO2;
	@Waveform(loc="0x07",  code="etCO2", desc="Exp CO" + two_subscript, freq=126, spp=WF_PACKET_SIZE, unit="kPa") private int [] EtCO2kpa;
	@Waveform(loc="0x08",  code="etCO2", desc="Exp CO" + two_subscript, freq=126, spp=WF_PACKET_SIZE, unit="%" ) private int [] EtCO2pct; // Vol%
