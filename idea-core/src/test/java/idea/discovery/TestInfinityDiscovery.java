...
public class TestInfinityDiscovery implements DiscoveryListener {
	InfinityDiscoveryWorker worker;
...
//		TestProbeData.init(study);
		...
		worker = new InfinityDiscoveryWorker();
		
		worker.addListener( this);
		worker.setMonitoringUnits("0,1,2" );
