...
import org.dellroad.jvser.AbstractComPortCommandSwitch;
import org.dellroad.jvser.BaudRateCommand;
import org.dellroad.jvser.ComPortCommand;
import org.dellroad.jvser.ComPortOptionHandler;
...
import org.dellroad.jvser.RFC2217;
import org.dellroad.jvser.SignatureCommand;
import org.dellroad.jvser.StopSizeCommand;
import org.dellroad.jvser.TransmitBinaryOptionHandler;
import org.dellroad.jvser.Version;
...
public class TelnetSerialPort extends SerialPort {
    ...
    public TelnetSerialPort() {
        ...
        this.telnetClient.registerInputListener(new TelnetInputListener() {
            ...
            public void telnetInputAvailable() {
                ...
                if (notify)
                    TelnetSerialPort.this.sendEvent(SerialPort.LISTENING_EVENT_DATA_AVAILABLE);
            }
        });
    }
	...
	public int getBaudBase() throws UnsupportedCommOperationException, IOException {
		log.error("Unexpected call: getBaudBase()");
		return 0;
	}

	@Override
	public boolean getCallOutHangup() throws UnsupportedCommOperationException {
		log.error("Unexpected call: getCallOutHangup()");
		return false;
	}
