...
@Slf4j
public class MindraySerialDriver extends HL7AbstractDriver  {
	private static final String driverName="monitor/Mindray Serial";
	...
	public static SerialDeviceConfiguration createConfigInstance() {
		SerialDeviceConfiguration conf = new SerialDeviceConfiguration(MindraySerialDriver.class);
		conf.setName("MindRaySerial");
		return conf;
	}

	public MindraySerialDriver(DeviceConfiguration conf) {
		super(caps, conf);
