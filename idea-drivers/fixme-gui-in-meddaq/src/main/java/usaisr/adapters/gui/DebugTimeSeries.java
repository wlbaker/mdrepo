 ...
 */
public class DebugTimeSeries extends TimeSeries implements Cloneable, Serializable {
     ...
     */
    public DebugTimeSeries(Comparable name) {
     ...
     * @since 1.0.13
     */
    public DebugTimeSeries(Comparable name, String domain, String range) {
        super(name);
        this.domain = domain;
        this.range = range;
     ...
     */
    public Collection getTimePeriodsUniqueToOtherSeries(DebugTimeSeries series) {
        Collection result = new java.util.ArrayList();
     ...
     */
    public DebugTimeSeries addAndOrUpdate(DebugTimeSeries series) {
        DebugTimeSeries overwritten = new DebugTimeSeries("Overwritten values from: "
                + getKey());
        for (int i = 0; i < series.getItemCount(); i++) {
    ...
    public Object clone() throws CloneNotSupportedException {
        DebugTimeSeries clone = (DebugTimeSeries) super.clone();
     ...
     */
    public DebugTimeSeries createCopy(int start, int end)
        ...
        DebugTimeSeries copy = (DebugTimeSeries) super.clone();
     ...
     * @throws CloneNotSupportedException if there is a cloning problem.
     */
    public DebugTimeSeries createCopy(RegularTimePeriod start, RegularTimePeriod end)
        throws CloneNotSupportedException {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DebugTimeSeries)) {
            return false;
        }
        DebugTimeSeries that = (DebugTimeSeries) object;
     ...
     */
    public DebugTimeSeries(Comparable name, Class timePeriodClass) {
        this(name, DEFAULT_DOMAIN_DESCRIPTION, DEFAULT_RANGE_DESCRIPTION,
                timePeriodClass);
    }
