...
/**
 * PostDetectProcessor.java
 */


public class PostDetectProcessor extends BeatMatcher {


	public PostDetectProcessor(int sr) {
		super(sr);
	}


	/****************************************************************
	PostDetectProcessor contains functions for classifying beats based after the
	...
	CheckPostClass() --  classifies beat type based on the last
	...
	protected static int PCInitCount = 0 ;
