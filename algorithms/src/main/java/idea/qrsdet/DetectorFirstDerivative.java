...
public class DetectorFirstDerivative extends AbstractDetector {
	...
	public DetectorFirstDerivative(int sr) {
		setSampleRate(sr);
		getConfiguration().setName("DetectorFirstDerivative");
	}
	...
	public int _getValue(int datum) {
		...
		sb1datum = filter.deriv1(sb1datum, 0);
