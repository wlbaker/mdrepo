...
extern "C" JNIEXPORT jdoubleArray JNICALL Java_ni_DAQmx_MxAnalogMultiChannelReader_readSingleSample(
	...
	if (nchannels > 0) {
		...
		DAQmxErrChk (DAQmxReadAnalogF64(taskHandle,1,10.0,DAQmx_Val_GroupByChannel,data,nchannels, &read,NULL));
...
extern "C" JNIEXPORT jobject JNICALL Java_ni_DAQmx_MxAnalogMultiChannelReader_beginReadWaveform(
