...
Source:         https://github.com/google/protobuf/archive/v%{version}%{?rcver}/%{name}-%{version}%{?rcver}.tar.bz2
...
# wlb -- no patch Patch0:         0001-fix-build-on-s390x.patch
...
#nonano %package javanano
#nonano Summary:        Protocol Buffer JavaNano API
#nonano BuildArch:      noarch
#nonano 
#nonano %description javanano
#nonano JavaNano is a special code generator and runtime
#nonano library designed specially for resource-restricted
#nonano systems, like Android.
...
#nonano # used by https://github.com/googlei18n/libphonenumber
#nonano %pom_xpath_inject "pom:project/pom:modules" "<module>../javanano</module>" java
#nonano %pom_remove_parent javanano
#nonano %pom_remove_dep org.easymock:easymockclassextension javanano
...
#nonano %files javanano -f .mfiles-protobuf-javanano
#nonano %doc javanano/README.md
#nonano %license LICENSE
