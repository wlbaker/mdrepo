...
configure_make() {
  ...
  then
	...
	echo DISTRIB_PATH=`pwd`/../distribution/libs/${TARGET_ARCH}
    [ -d ${DISTRIB_PATH}/include ] || mkdir -p ${DISTRIB_PATH}/include
    echo cp -r ${LIB_DEST_DIR}/${ABI}/include/curl ${DISTRIB_PATH}/include
    cp -r ${LIB_DEST_DIR}/${ABI}/include/curl ${DISTRIB_PATH}/include

    [ -d ${DISTRIB_PATH}/lib ] || mkdir -p ${DISTRIB_PATH}/lib
    cp ${LIB_DEST_DIR}/${ABI}/lib/libcurl.a ${DISTRIB_PATH}/lib
  fi;
  popd;
}
