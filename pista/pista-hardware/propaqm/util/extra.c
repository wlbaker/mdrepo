...
/*
#include "simu/simu-api.h"

#include "imp731/imp731.h"
#include "medsys3/medsys3.h"
...
#ifdef HAVE_MCCUL
#include "mcc-ul/mcc-ul.h"
#endif

#ifdef HAVE_PROPAQM
#include "propaqm/propaqm.h"
#ifdef HAVE_AVAHICLIENT_XXX
#include "service/propaq_disc/pp_api.h"
#endif
#endif

#ifdef HAVE_BMP180
#include "bmp180/bmp180-api.h"
#endif
*/
...
void _pista_init_driver(struct pista_context *ctx, struct pista_dev_driver *pd ) {
...
void _pista_init_service(struct pista_context *ctx, struct pista_discovery_service *service ) {
    service->init(ctx, service );
 ...
 * for maintenance operations.  The tick method is called approximately once/second 
 * This is usually handled with a cooperative threading model.
 */
 ...
 * Unused???
 * */
PISTA_API int pista_dev_init( struct pista_context *ctx, struct pista_dev_driver *dev )
{
    return dev->init( ctx, dev );
}
