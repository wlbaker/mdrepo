    ...
    : QDialog(parent), bonjourResolver(0)
{
    ...
    setWindowTitle(tr("Fortune Client: ZOLL.local"));
    treeWidget->setFocus();
    // bonjourBrowser->browseForServiceType(QLatin1String("_trollfortune._tcp"));
    // bonjourBrowser->browseForServiceType(QLatin1String("_ZOLL_https._tcp.X-Series.device.ZOLL.local"));
    bonjourBrowser->browseForServiceType(QLatin1String("ZOLL.local"));
}
