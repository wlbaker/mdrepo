...
baseDir <- "V:/HiFi Research/2. Waveform Analysis ISR/ISR_HEM1_Rubal/analysis/"
timelineFile <- "Monday (2).xlsx"

f <- paste( baseDir, timelineFile, sep="" )

tldf <- read.xlsx( f, sheetIndex=1 )
