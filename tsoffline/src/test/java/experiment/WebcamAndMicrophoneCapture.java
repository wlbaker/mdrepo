...
{ 
	...
	static protected ScheduledThreadPoolExecutor exec; 
    ...
    { 
        ...
        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder( 
                "/tmp/f0.flv", // "rtmp://my-streaming-server/app_name_here/instance_name/stream_name", 
        ...
        // 192 Kbps 
        recorder.setAudioBitrate(192000/4); 
        recorder.setSampleRate(44100/4); 
        ...
        new Thread(new Runnable() { 
            ...
            { 
                ...
                AudioFormat audioFormat = new AudioFormat(44100.0F/4, 16, 2, true, false); 
