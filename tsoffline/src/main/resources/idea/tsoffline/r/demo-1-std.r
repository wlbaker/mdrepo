...
plot( x=xx, y=yy, typ='l', xlab=sig_name, ylab="")
abline( v=r_x, col='blue' )

# ***************************************************
# Simple R-wave plot
# ***************************************************

# plot( x=r_x, y=r_y, typ='l', 
#	xlab=paste("RWave Data:", r_x[1], "to", tail(r_x,1) ), 
#	ylab="")
...
spectrum(yy, typ='S', xlim=c(0,50) )
spec <- spectrum(yy, typ='S', spans=c(3,5), xlim=c(0,50) )
...
plot( my_integral, typ='l', xlim=c(0,50) )
